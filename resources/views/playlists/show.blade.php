...
<div class="min-h-screen bg-gradient-to-b from-black via-blue-950 to-black pb-24">
    <div class="container mx-auto px-4 py-8">
        <!-- Back Button -->
        <div class="mb-6">
            <a href="{{ route('playlists.index') }}" class="inline-flex items-center gap-2 text-white hover:text-green-500 transition-colors">
        ...
        <div class="flex flex-col md:flex-row gap-8 mb-12">
            ...
            <div class="flex-1">
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-4">{{ $playlist->PlaylistName }}</h1>

                @if($playlist->Description)
                <p class="text-zinc-300 mb-6 leading-relaxed">{{ strip_tags($playlist->Description) }}</p>
                @endif
...
@endphp
    // Store the song list for this playlist page
    ...
    // downloadSong function for playlist song lists
