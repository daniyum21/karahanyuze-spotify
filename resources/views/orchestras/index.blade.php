...
<div class="min-h-screen bg-gradient-to-b from-black via-blue-950 to-black">
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            ...
            <a href="{{ route('orchestre.show', $orchestra->slug) }}" class="bg-zinc-800 rounded-lg p-4 hover:bg-zinc-700 transition-colors block group">
                <div class="mb-4">
                    <img 
                ...
                <h3 class="font-semibold text-white mb-1">{{ $orchestra->OrchestreName }}</h3>
                <p class="text-sm text-zinc-400">{{ $orchestra->songs_count ?? 0 }} {{ $orchestra->songs_count == 1 ? 'song' : 'songs' }}</p>
            </a>
            @endforeach
        </div>
