    ...
    <div class="relative z-10 px-6 pt-8 pb-24">
        ...
        <div class="flex items-end gap-6 mb-8">
            ...
            <div class="flex-1 pb-4">
                <p class="text-sm text-white mb-2">Orchestra</p>
                <h1 class="text-5xl md:text-7xl font-bold text-white mb-4">{{ $orchestra->OrchestreName }}</h1>
                
                <div class="flex items-center gap-2 text-sm text-zinc-300">
                    <span>{{ $orchestra->songs->count() }} songs</span>
                </div>
            </div>
        </div>
                ...
                >
                    ...
                    <div class="flex items-center gap-3 flex-1 min-w-0">
                        ...
                        <div class="min-w-0 flex-1">
                            ...
                            <p class="text-zinc-400 text-sm truncate">{{ $orchestra->OrchestreName }}</p>
                        </div>
                    </div>
        ...
        <div class="bg-zinc-900/50 rounded-lg p-6 mb-8">
            ...
            <div class="text-zinc-300 whitespace-pre-wrap">{{ strip_tags($orchestra->Description) }}</div>
        </div>
        @endif
    </div>
</div>
...
@php
    $songList = $orchestra->songs->map(function($song) {
        return [
            ...
            'artist' => $song->orchestra ? $song->orchestra->OrchestreName : 'Unknown',
