...
<div class="min-h-screen bg-gradient-to-b from-black via-blue-950 to-black">
    <div class="container mx-auto px-4 py-12">
        <div class="max-w-4xl mx-auto">
            <div class="mb-8">
                <h1 class="text-4xl font-bold text-white mb-2">Create New Itorero</h1>
                <p class="text-zinc-400">Add a new itorero to the Karahanyuze collection. After creating the itorero, you'll be able to upload songs for them.</p>
            </div>
            ...
            <form action="{{ route('user.itoreros.store') }}" method="POST" enctype="multipart/form-data" class="bg-zinc-900 rounded-lg p-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="4"
                            class="w-full px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                            placeholder="Enter itorero description (optional)"
                    ...
                    <div>
                        ...
                        >
                        <p class="text-xs text-zinc-500 mt-2">Maximum file size: 2MB. Supported formats: JPEG, JPG, PNG</p>
                    </div>
                </div>
                ...
                <div class="mt-8 flex gap-4">
                    ...
                    <a href="{{ route('dashboard') }}" class="px-6 py-3 bg-zinc-800 hover:bg-zinc-700 text-white font-semibold rounded-lg transition-colors">
                        Cancel
                    </a>
                </div>
            </form>
