    ...
    <div class="container mx-auto px-4 py-12">
        <div class="max-w-4xl mx-auto">
            <div class="mb-8">
                ...
                <p class="text-zinc-400">Add a new artist to the Karahanyuze collection. After creating the artist, you'll be able to upload songs for them.</p>
            </div>
            ...
            <form action="{{ route('user.artists.store') }}" method="POST" enctype="multipart/form-data" class="bg-zinc-900 rounded-lg p-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-blue-500/20 border border-blue-500 text-blue-400 px-4 py-3 rounded-lg">
                        <p class="text-sm">
                            <strong>Note:</strong> After creating the artist, you'll be redirected to upload songs for this artist. All content will be reviewed and approved by an administrator before being published.
                        </p>
                    </div>
                    ...
                    <div class="flex gap-4 pt-4">
                        ...
                        >
                            Create Artist & Continue to Upload Songs
                        </button>
                        <a 
                            href="{{ route('home') }}" 
