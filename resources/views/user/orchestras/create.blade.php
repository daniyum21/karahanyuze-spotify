...
@section('title', 'Create Orchestra')
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="max-w-4xl mx-auto">
            <div class="mb-8">
                ...
                <p class="text-zinc-400">Add a new orchestra to the Karahanyuze collection. After creating the orchestra, you'll be able to upload songs for them.</p>
            </div>
            ...
            <form action="{{ route('user.orchestras.store') }}" method="POST" enctype="multipart/form-data" class="bg-zinc-900 rounded-lg p-8">
                @csrf
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            rows="4"
                            class="w-full px-4 py-2 bg-zinc-800 border border-zinc-700 rounded-lg text-white placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500"
                            placeholder="Enter orchestra description (optional)"
