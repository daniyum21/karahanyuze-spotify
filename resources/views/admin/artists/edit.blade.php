        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mt-6">
                <div class="bg-zinc-900 rounded-lg p-8 border border-zinc-700">
                    <h3 class="text-xl font-semibold text-white mb-4">Upload New Songs for {{ $artist->StageName }}</h3>
                    
                    <form action="{{ route('admin.artists.songs.store', $artist->UUID) }}" method="POST" enctype="multipart/form-data" id="upload-form">
                        @csrf
                        <input type="hidden" name="UmuhanziID" value="{{ $artist->UmuhanziID }}">
            ...
            <div class="mt-6">
                ...
                <p class="text-xs text-zinc-400 mb-3">Select existing songs to add to this artist</p>
