...
@section('title', 'Create Itorero - Admin')
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="max-w-4xl mx-auto">
            <div class="mb-8">
                ...
                <p class="text-zinc-400">Add a new itorero to the Karahanyuze collection</p>
            </div>
            ...
            <form action="{{ route('admin.itoreros.store') }}" method="POST" enctype="multipart/form-data" class="bg-zinc-900 rounded-lg p-8">
                @csrf
